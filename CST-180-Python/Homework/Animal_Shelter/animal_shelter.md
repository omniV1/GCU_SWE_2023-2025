...
@define-color background #13110f;
@define-color foreground #ffffff;

@define-color color0 #13110f;
@define-color color1 #60A2AD;
@define-color color2 #77DCEE;
@define-color color3 #B1B09C;
@define-color color4 #DDD8A6;
@define-color color5 #8EE8F2;
@define-color color6 #A9EAE9;
@define-color color7 #e8ede1;
@define-color color8 #a2a59d;
@define-color color9 #a3c9d0;
@define-color color10 #d2f3f9;
@define-color color11 #deded5;
@define-color color12 #f9f8f0;
@define-color color13 #e9fbfd;
@define-color color14 #fbfefe;
